...
theme.groups = function(colors)
  ...
  return {
    ...
    LspReferenceRead = { bg = colors.bg2, gui = styles.underline },
    LspReferenceText = { bg = colors.bg2, gui = styles.underline },
    LspReferenceWrite = { bg = colors.bg2, gui = styles.underline },
